...
- **Global scope**: `C:/Users/C/Documents/Savage22 Server/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/C/Documents/Savage22 Server/.claude/notes/`)
...
2. Glob `C:/Users/C/Documents/Savage22 Server/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/C/Documents/Savage22 Server/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/C/Documents/Savage22 Server/.claude/notes/` — works in any directory
