...
- NO FILTERING of features. XGBoost decides via tree splits, not us
...
- Cloud docker: rapidsai/base (cuDF+CuPy+XGBoost pre-installed), pip install lightgbm+numba on top
