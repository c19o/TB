...
LSTM_CONFIG = {
    '5m':  {'window': 60,  'hidden': 384, 'layers': 2, 'lr': 0.0005, 'epochs': 80,  'batch': 48},
...
def get_sequence_feature_list():
    """Get flat list of all sequence features."""
    features = []
    for group in SEQUENCE_FEATURES.values():
...
def prepare_data(tf_name):
    ...
    # Get target column
    tf_label = {'5m': '5m', '15m': '15m', '1h': '1h', '4h': '4h', '1d': '1d', '1w': '1w'}
