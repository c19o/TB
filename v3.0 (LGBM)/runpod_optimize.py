...
def main():
    ...
    try:
        ...
        opt_cmd = (
            ...
            "python -c \"import json,glob; configs={}; [configs.update(json.load(open(f))) for f in glob.glob('optuna_configs_*.json')]; json.dump(configs, open('optuna_configs.json','w'), indent=2); print('Merged', len(configs), 'TF configs')\""
