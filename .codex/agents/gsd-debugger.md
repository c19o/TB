...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.codex
                  → checks C:/Users/C/Documents/Savage22 Server/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/C/Documents/Savage22 Server/.codex/get-shit-done
                  → writes to C:/Users/C/Documents/Savage22 Server/.codex/get-shit-done/hooks/
...
```bash
INIT=$(node "C:/Users/C/Documents/Savage22 Server/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/C/Documents/Savage22 Server/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/C/Documents/Savage22 Server/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
