...
# THP "always" causes multi-second stalls during LightGBM's small-alloc phase.
# "defer+madvise" = background kcompactd for most pages, synchronous only for
# madvise-annotated regions (tcmalloc's arenas). Best for batch ML.
